...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    TabsA.color-acento-botones.mb-5(style="background-color=#DBF9BD")
      ...
      .tarjeta.colorprimario--borde.p-4(titulo="Secuencial")
        h4
        p La estructura del formulario de preguntas debe tener una secuencia, de manera que no se pase de un tema a otro intempestivamente. Ejemplo: número de aves, consumo de concentrado por día, número de huevos por día, número de aves por jaula.
      .tarjeta.colorprimario--borde.p-4(titulo="Universal")
        h4
        p El formato puede ser empleado en cualquier unidad productiva, que posea similares condiciones, independientemente de la región, la cultura o las costumbres de los colaboradores o las personas que hagan la captura de información.
      .tarjeta.colorprimario--borde.p-4(titulo="Puntual")
        h4
        p Se debe procurar recoger datos puntuales, ojalá cifras concretas. Ejemplo: número de bultos de melaza, número de hectáreas en bosque, altitud sobre el nivel del mar.
      .tarjeta.colorprimario--borde.p-4(titulo="Preguntas cerradas")
        h4
        p En caso de hacer preguntas a pobladores de la zona o a trabajadores de la unidad productiva estas deben ser cerradas. Ejemplo: en qué meses llueve más – cuántos kilogramos cosechó ayer – cuántos animales están enfermos.
      .tarjeta.colorprimario--borde.p-4(titulo="Fácil comprensión")
        h4
        p Se deben formular las preguntas de manera que cualquier persona, independientemente de su nivel de escolaridad, experiencia o conocimientos pueda entenderlas. Se debe preguntar sin exagerar conceptos técnicos promoviendo siempre una conversación amena.
      .tarjeta.colorprimario--borde.p-4(titulo="Preguntas cortas")
        h4
        p Preguntas que faciliten la respuesta del interlocutor o que correspondan a datos precisos. Ejemplo: cuántos animales hay en el potrero 2, cuántos kilogramos de alimento se están consumiendo por alojamiento, cuántos litros de leche produjo la vaca 506.
      .tarjeta.colorprimario--borde.p-4(titulo="Fácil sistematización")
        h4
        p Para esto es importante formular preguntas exactas con respuestas precisas como número de conejos en la jaula 2, cuántos toros tiene en su rebaño, cuántos kilogramos de queso se produjeron la semana pasada, cuántos pollos se sacrificaron en enero.
      .tarjeta.colorprimario--borde.p-4(titulo="Datos precisos")
        h4
          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  h4.mb-1 Plataformas para crear formularios en línea para tu negocio
                  p.text-small.mb-0 https://impulsapopular.com/tecnologia/plataformas-para-crear-formularios-en-linea-para-tu-negocio/
                .col-sm-auto
                  a.boton.color-acento-botones(href="https://impulsapopular.com/tecnologia/plataformas-para-crear-formularios-en-linea-para-tu-negocio/" target="_blank")
                    span Enlace web
        ...
        .tabla.mb-5
          table
            ...
            tr
              ...
              td Inventario y caracterización del hato – registro de nacimientos – registros de producción – registro de servicios reproductivos – control de peso.
            tr
              td Producción avícola
              td Producción de huevo – inventario de aves – consumo de concentrado diario – conversión de alimento – mortalidad diaria – mortalidad acumulada.
            tr
              td Producción porcícola
              td Edad de la primera monta en meses - Peso corporal en kilogramos – Conversión de alimento en kilogramos – Edad al sacrificio en meses – Intervalo destete monta en meses – Número de abortos – Porcentaje de partos por total de hembras en edad reproductiva – Lechones nacidos vivos por camada – Lechones nacidos muertos – Partos/Cerda/Año. 
            tr
              td Especies menores
              td Edad destete en días – Peso crías al nacer en gramos – Número de crías al año – Partos al año – Peso en gramos – Camadas/hembra/año – Peso crías al destete en gramos – Edad al sacrificio en días – Madurez sexual machos en días – Madurez sexual hembras en días.
            tr
              td Producción piscícola
              td Peso inicial en gramos – Peso final en gramos – Edad al sacrificio en días – Densidad: número de animales por metro cúbico – Ingesta total individuo en gramos – Longitud total final individuo en centímetros – Porcentaje de mortalidad.
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-12
        ...
        AcordionA(tipo="b" clase-tarjeta="tarjeta tarjeta-verde")
          .row(titulo="Identificar las unidades que se manejan en el registro")
            .col-md-12.mb-4.mb-md-0
              p En algunas ocasiones se manejan unidades diferentes a las tradicionalmente utilizadas, por lo que es necesario identificar el sistema de unidades y disponer de la información necesaria para hacer las respectivas conversiones. Por ejemplo, pasar de fanegadas a hectáreas, de arrobas a kilogramos, de quintales a kilogramos.
          .row(titulo="Tener claridad con el manejo de fracciones")
            .col-md-12.mb-4.mb-md-0
              p En algunas ocasiones se tienen dificultades en la calidad de la información debido a que se cometen errores con el diligenciamiento de las cifras decimales.
          .row(titulo="Procurar ingresar información al sistema")
            .col-md-12.mb-4.mb-md-0
              p En la actualidad es más sencillo acceder a dispositivos móviles, en los cuales la información se registra inmediatamente. En el proceso de tomar datos en papel y posteriormente digitalizarlos, es posible que se pierda o se tergiverse parte de la información. En este caso lo más recomendable es consignar la información en un medio magnético una vez se tenga la lectura en campo.
          .row(titulo="Hacer copias de seguridad de los datos diligenciados")
            .col-md-12.mb-4.mb-md-0
              p Si bien queda una copia impresa de los registros levantados en campo, es importante que al momento de digitalizarlos se creen las respectivas copias de seguridad. Incluso, una buena práctica en este sentido es enviar al correo electrónico una copia del trabajo realizado.
          .row(titulo="Tener una bitácora")
            .col-md-12.mb-4.mb-md-0
              p Es clave que además de los datos registrados se cuente por parte del personal de seguimiento con una bitácora en la que se registre información adicional del comportamiento de las unidades productivas. Esta información posteriormente será empleada para la toma de decisiones sobre el sistema productivo.
    Separador
    .row
      .col-xl-12       
    ...
    TabsA.color-acento-botones.mb-5(style="background-color=#DBF9BD")
      ...
      .tarjeta.colorprimario--borde.p-4(titulo="Designar responsable del cargue de información")
        h4 Designar responsable del cargue de información
        p Dejar trazabilidad de cada vez que se manipule la base de datos. Incluso es recomendable limitar el acceso a las bases de datos mediante el uso de contraseñas, las cuales deben cambiarse de forma periódica.
      .tarjeta.colorprimario--borde.p-4(titulo="Copia de seguridad de la información")
        h4 Copia de seguridad de la información
      ...
      .tarjeta.colorprimario--borde.p-4(titulo="Codificar nombres de archivos y carpetas")
        ...
        p Para el proceso de codificación por lo general se utilizan códigos alfanuméricos, por lo que es necesario definir un protocolo de asignación de nombres a los documentos y archivos.
        p Por ejemplo, si se desea dar un nombre a un archivo que lleva el registro diario de producción de leche. El nombre extenso sería REGISTRO DIARIO DE PRODUCCIÓN DE LECHE FINCA LA PRIMAVERA. 
        p En lugar de ello se pueden usar códigos como RD (registro diario) PL (producción lechera). Si se cuenta con un listado de fincas en orden alfabético y la finca La Primavera está en el puesto 23 este sería el código de la finca, por lo que el nombre codificado quedaría de la siguiente forma RDPL23.
      .tarjeta.colorprimario--borde.p-4(titulo="No utilizar caracteres especiales en nombres")
        h4 No utilizar caracteres especiales en nombres
        p Los nombres de archivos y carpetas no deben tener caracteres especiales, tales como puntos, tildes, signos o cualquier otro carácter que pueda dificultar la búsqueda de los archivos. 
        p En algunos casos cuando el archivo se traslada a otro sistema de base de datos pueden perderse algunos datos importantes. Igualmente, es importante tener en cuenta que nunca existan espacios al inicio o al final de un campo de texto. 
        p En el cuerpo de las bases de datos solo se deben incluir datos numéricos, nunca se deben incluir caracteres adicionales como unidades (Kg, $, m, U$, % o #). Para especificar las unidades es necesario incluir esta información en el encabezado.
    ...
    .tarjeta.tarjeta--gris.p-4.mb-5(style="background-color:#EBEEE8")
      PasosB.color-primario
        .row(titulo="")
          .row.justify-content-center.align-items-center.mb-5
            .col-lg-6              
              h3 Título del informe
              p En el título se debe dar información específica al lector sobre el tipo de explotación objeto del seguimiento, el lugar, las variables analizadas y el periodo al que corresponden las observaciones. Ejemplo: #[b “Evaluación de la producción de leche en la finca la clarita, municipio de Sibaté entre el 01-10-2020 y el 01-09-2021”]
            .col-lg-6   
              figure
        ...
        .row(titulo="")
          .row.justify-content-center.align-items-center.mb-5
            .col-lg-6              
              h3 Fecha
              p Se debe especificar la fecha en la que se presenta el reporte, pues no siempre esta coincide con la fecha en la que se realizaron las mediciones o la captura de datos.
            .col-lg-6   
              figure
        ...
        .row(titulo="")
          .row.justify-content-center.align-items-center.mb-5
            .col-lg-6              
              h3 Responsable
              p Se debe especificar el nombre del responsable de la elaboración del reporte y en lo posible especificar el cargo que ocupa dentro de la unidad productiva.
            .col-lg-6   
              figure
        ...
        .row(titulo="")
          .row.justify-content-center.align-items-center.mb-5
            .col-lg-6              
              h3 Resumen
              p Para el lector es de suma importancia tener una idea general de los hallazgos que se encontraron en el proceso de observación al interior de la unidad productiva, sin entrar a especificar detalles o describir los pormenores de la situación.
            .col-lg-6   
              figure
        ...
        .row(titulo="")
          .row.justify-content-center.align-items-center.mb-5
            .col-lg-6              
              h3 Identificación de situaciones
              p Es fundamental resaltar aspectos clave del proceso de observación que permitan identificar situaciones fuera de lo común que requieran especial atención. Por ejemplo: “… en el mes de enero de 2021 la producción de leche se redujo en un 25 % en comparación con el mes inmediatamente anterior…”
            .col-lg-6   
              figure
        ...
        .row(titulo="")
          .row.justify-content-center.align-items-center.mb-5
            .col-lg-6              
              h3 Resultados de la observación
              p Esta parte del reporte se debe centrar en la presentación de los datos observados en el proceso de seguimiento, especialmente recurriendo a información gráfica, cuadros, tablas y demás recursos que permitan mostrar al lector el comportamiento de las variables en un periodo determinado de tiempo. No se requiere desarrollar cálculos estadísticos avanzados.
            .col-lg-6   
              figure
        ...
        .row(titulo="")
          .row.justify-content-center.align-items-center.mb-5
            .col-lg-6              
              h3 Revisión de trazabilidad
              p Pero es recomendable revisar promedios históricos, tendencias y demás elementos que faciliten detectar comportamientos fuera de lo común. En este punto es importante describir lo que se observa en los datos presentados sin recurrir a especulaciones o planteamientos de hipótesis sobre las causas de las variaciones en la información, si se llegasen a presentar.
            .col-lg-6   
              figure
    ...
    AcordionA(tipo="b" clase-tarjeta="tarjeta tarjeta-verde")
      ...
      .row(titulo="Planillas levantadas en campo")
        .col-md-12.mb-4.mb-md-0
          p En la unidad productiva es común que se manejen registros diarios de las actividades que se llevan a cabo de manera rutinaria, como ocurre con las labores de aseo y desinfección, mantenimiento, alimentación de animales, manejo sanitario e implementación de protocolos, lo cual es una fuente de información que puede respaldar los datos encontrados en los reportes de novedades.
      .row(titulo="Registros")      
        .col-md-12.mb-4.mb-md-0
          p Los registros son la base para la elaboración de los reportes de novedades, por lo que, en algunos casos, es importante anexar copias de estos para reforzar los conceptos analizados en los documentos presentados.
      .row(titulo="Registro fotográfico")
        .col-md-12.mb-4.mb-md-0
          p Con los avances tecnológicos es posible acopiar una importante cantidad de información fotográfica que puede respaldar los contenidos de los reportes y dar una visión general de las situaciones que se presentan al interior de la unidad productiva. Si bien es un material importante, es recomendable manejar un bajo volumen de información fotográfica debido a la gran cantidad de espacio que ocupan este tipo de archivos en las bases de datos.
          p Para evitar la saturación de las bases de datos con archivos fotográficos, es posible definir un protocolo para su almacenamiento donde se defina qué tipo de fotografías se almacenarán, qué formatos se manejarán, qué tamaño tendrán los archivos y cuál será el límite, en tamaño, de la carpeta de imágenes.

    .text-decor.text-white.text-center(data-aos="flip-up").mb-5
      p.mt-3.p-2 Conclusiones
